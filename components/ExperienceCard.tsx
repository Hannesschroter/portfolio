...
export default function ExperienceCard({project}: Props) {
  return (
    ...
    // <Spotlight>
    <article className="flex flex-col relative max-h-[550px] sm:max-h-650 lg:max-h-none rounded-lg items-center space-y-7 flex-shrink-0 w-[100%] sm:w-[500px] md:w-[600px] xl:w-[700px]
