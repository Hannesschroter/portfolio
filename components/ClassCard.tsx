...
function ClassCard({}: Props) {
  return (
    <div className="flex flex-col">
        <div className="flex flex-col relative rounded-3xl space-y-5 flex-shrink-0 items-center max-h-90
         bg-slate-500 backdrop-filter px-3 backdrop-blur-sm bg-opacity-10 pt-6 px-4 pb-5 mx-3 overflow-hidden shadow-slate-700 shadow-md max-w-sm">
