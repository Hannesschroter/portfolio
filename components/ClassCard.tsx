  ...
  return (
    <div className="flex flex-col relative">
        <div className="flex flex-col relative rounded-3xl space-y-5 flex-shrink-0 items-center
         bg-slate-500 backdrop-filter px-3 backdrop-blur-sm bg-opacity-10 pt-6 px-4 pb-5 mx-3 overflow-hidden shadow-slate-800 shadow-sm max-w-xs">
        ...
        <Icon icon={icon}/>
        <h2 className="text-base tracking-widest font-light text-slate-200 font-bold mb-1">{headline}</h2>
        <p className="text-sm font-light pl-4 pr-4 pb-4 md:text-center"> {presentation}</p>
        </div>
    </div>
  )
}
