...
function Skills({skills}: Props) {
  return (
    ...
    <h4 className="mt-10 md:mt-10 uppercase tracking-[3px] text-gray-500 dark:text-gray-100"> Languages </h4>
    ...
    <h4 className="mt-10 md:mt-10 uppercase tracking-[3px] text-gray-500 dark:text-gray-100"> Programming Languages </h4>
    ...
    <h4 className="mt-10 md:mt-10 uppercase tracking-[3px] text-gray-500 dark:text-gray-100"> Technology </h4> 
    ...
    <h4 className="mt-10 md:mt-10 uppercase tracking-[3px] text-gray-500 dark:text-gray-100"> Management </h4> 
