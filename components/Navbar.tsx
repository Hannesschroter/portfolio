...
export default function Navbar({ }: Props) {
  ...
  return (
    <nav className="fixed flex flex-col bottom-5 w-full items-center justify-center z-30">
      ...
      className="w-[95%] max-w-sm p-2 text-xl bg-gray-200 dark:bg-gray-600 px-2 bg-opacity-60 dark:bg-opacity-20 backdrop-blur-sm backdrop-filter rounded-full flex flex-row gap-1 text-gray-600 dark:text-gray-100 items-center justify-center">
