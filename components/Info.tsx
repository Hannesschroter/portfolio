...
function Info({pageInfo}: Props) {
    ...
    return (
        ...
        <img className="relative  sm:mt-[20%] md:mt-[12%] lg:mt-[0%] h-32 w-32 sm:h-36 sm:w-36 md:h-48 md:w-48 rounded-full object-cover object-top"
        src={urlFor(pageInfo.heroImage).url()}
        alt="" /> 
        <div className="z-10">
        <h2 className="text-sm uppercase text-gray-500 pb-2 tracking-[10px] mt-10"> {pageInfo?.role}</h2>
        <h1 className="text-2xl min-h-[62px] md:min-h-[82px] px-1 font-semibold text-slate-700 dark:text-slate-200 scroll-px-10 mt-5">
