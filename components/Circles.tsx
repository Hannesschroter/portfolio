...
function Circles({}: Props) {
  return (
    <>
      ...
      <div className="absolute mask aspect-square -mt-[15%] md:mt-0 lg:mt-[5%] w-[120%] md:h-[1200px] md:w-[1200px] xl:h-[1512px] xl:w-[1512px] sm:h-[1070px] sm:w-[1070px] stroke-gray-300/70">
