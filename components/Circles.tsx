...
function Circles({}: Props) {
  return (
    <>
      ...
      <div className="absolute mask aspect-square -mt-[40%] sm:-mt-[20%] md:mt-0 lg:mt-[5%] w-[120%] md:h-[900px] md:w-[900px] lg:h-[950px] lg:w-[950px] xl:h-[1000px] xl:w-[1000px] sm:h-[750px] sm:w-[750px] stroke-gray-100/90 dark:stroke-gray-300/70">
