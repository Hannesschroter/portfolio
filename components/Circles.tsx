...
function Circles({}: Props) {
  return (
    <div className="relative flex justify-center items-center">
      ...
      <div className="absolute mask self-center m-auto -top-56  h-[700px] w-[700px] md:h-[1200px] md:w-[1200px] xl:h-[1512px] xl:w-[1512px] sm:h-[1070px] sm:w-[1070px] stroke-gray-300/70 sm:-top-64 md:-top-72 lg:-top-24 lg:ml-12 xl:-top-96 xl:ml-0">
